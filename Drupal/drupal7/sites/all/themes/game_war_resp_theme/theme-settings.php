 ...
 *   The form state.
 */
function game_war_resp_theme_form_system_theme_settings_alter(&$form, &$form_state) {

  $form['prof_settings'] = array(
    '#type' => 'fieldset',
    '#title' => t('War Game Responsive Theme'),
    '#collapsible' => FALSE,
    '#collapsed' => FALSE,
  );
  $form['prof_settings']['breadcrumbs'] = array(
    ...
    '#default_value' => theme_get_setting('breadcrumbs','game_war_resp_theme'),
  ...
  $form['prof_settings']['top_social_link']['social_links'] = array(
    ...
    '#default_value' => theme_get_setting('social_links', 'game_war_resp_theme'),
  ...
  $form['prof_settings']['top_social_link']['twitter_username'] = array(
    ...
    '#default_value' => theme_get_setting('twitter_username', 'game_war_resp_theme'),
  ...
  $form['prof_settings']['top_social_link']['facebook_username'] = array(
    ...
    '#default_value' => theme_get_setting('facebook_username', 'game_war_resp_theme'),
